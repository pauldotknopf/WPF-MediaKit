...
HRESULT EVRCustomPresenter::CanConstrict(BOOL *pYes)
{
	*pYes = false;
	return S_OK;
}

HRESULT EVRCustomPresenter::SetConstriction(DWORD dwKPix)
{
	return S_OK;
}

HRESULT EVRCustomPresenter::DisableImageExport(BOOL bDisable)
{
	return S_OK;
}
