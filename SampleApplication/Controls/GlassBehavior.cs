...
namespace SampleApplication.Controls
{
    ...
    public class GlassBehavior : Behavior<FrameworkElement>
    {
        ...
        public GlassBehavior()
        {
            ...
            RenderOptions.SetBitmapScalingMode(m_directVisualBrush, BitmapScalingMode.Linear);
            ...
            RenderOptions.SetCachingHint(m_surrogateVisual, CachingHint.Cache);
            RenderOptions.SetBitmapScalingMode(m_surrogateVisual, BitmapScalingMode.Linear);
            ...
            m_surrogateVisualBrush.AutoLayoutContent = false;
        }
